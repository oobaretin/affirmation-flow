...
Copy these into App Store Connect when your developer account is active. Edit anything that doesn’t sound like you.
...
|-------|-------|
| **App name** | AffirmEaze |
| **Subtitle** | Calm daily affirmations |
| **Bundle ID** | com.affirmationflow.app |
| **Primary category** | Health & Fitness |
| **Secondary category** | Lifestyle |
| **Age rating** | 4+ |
| **Price** | Free (subscription required in app) |

## Promotional text (170 chars max)

Start your day with calm, spoken affirmations. Personalize your focus, build streaks, and grow a practice that feels gentle — not forced.
...
Your affirmations, favorites, and settings stay on your device. No account required.

Questions? support@affirmeaze.app

## Keywords (100 chars max, comma-separated)

```
affirmation,mantra,self love,mindfulness,calm,daily motivation,gratitude,meditation,positive
```
...
Restore Purchases is on the paywall and in Settings → Subscription.
